...
import com.alchitry.kotlinmultiplatform.Math
import com.alchitry.kotlinmultiplatform.errMessage
...
object RuntimeMetaData {
    ...
    fun checkVersion(generatingToolVersion: String?, compileTimeVersion: String) {
        val runtimeVersion = this.runtimeVersion
        var runtimeConflictsWithGeneratingTool = false
        var runtimeConflictsWithCompileTimeTool = false

        if (generatingToolVersion != null) {
            runtimeConflictsWithGeneratingTool = runtimeVersion != generatingToolVersion && getMajorMinorVersion(runtimeVersion) != getMajorMinorVersion(generatingToolVersion)
        }
     ...
     */
    fun getMajorMinorVersion(version: String): String {
