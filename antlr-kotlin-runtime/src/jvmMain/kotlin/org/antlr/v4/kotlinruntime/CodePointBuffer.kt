 ...
 */
public class CodePointBuffer private constructor(
  ...
  public operator fun get(offset: Int): Int {
    return when (type) {
  ...
  public fun charArray(): CharArray {
    assert(type == Type.CHAR)
    return charBuffer!!.array()
  }

  public fun intArray(): IntArray {
    assert(type == Type.INT)
    return intBuffer!!.array()
  }

  public class Builder(initialBufferSize: Int) {
    public var type: Type
      private set
    public var byteBuffer: ByteBuffer?
      private set
    public var charBuffer: CharBuffer? = null
      private set
    ...
    public fun build(): CodePointBuffer {
      when (type) {
    ...
    public fun ensureRemaining(remainingNeeded: Int) {
      when (type) {
    ...
    public fun append(utf16In: CharBuffer) {
  ...
  public companion object {
    public fun withBytes(byteBuffer: ByteBuffer?): CodePointBuffer {
      return CodePointBuffer(Type.BYTE, byteBuffer, null, null)
    }

    public fun withChars(charBuffer: CharBuffer?): CodePointBuffer {
      return CodePointBuffer(Type.CHAR, null, charBuffer, null)
    }

    public fun withInts(intBuffer: IntBuffer?): CodePointBuffer {
      return CodePointBuffer(Type.INT, null, null, intBuffer)
    }

    public fun builder(initialBufferSize: Int): Builder {
