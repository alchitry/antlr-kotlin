 ...
 */
public abstract class CodePointCharStream private constructor(position: Int, remaining: Int, name: String) : CharStream {
  ...
  // Visible for testing.
  public abstract val internalStorage: Any
  ...
  public companion object {
     ...
     */
    @JvmOverloads
    public fun fromBuffer(codePointBuffer: CodePointBuffer, name: String = UNKNOWN_SOURCE_NAME): CodePointCharStream {
